...
const Hero = () => {
  ...
  return (
    <main
      className="flex flex-col lg:justify-between py-8 px-6 lg:px-12"
      style={{
    ...
    >
      ...
      <nav className="flex items-center justify-between">
        ...
        <ul className="hidden lg:flex py-4 px-8 gap-8 bg-[#166636] rounded-full text-white text-sm">
          <Link href='/about' onClick={() => setMenuOpen(false)} className="cursor-pointer">About</Link>
      ...
      <div className="lg:hidden flex justify-between items-center relative">
        <div className={`absolute top-[20px] left-0 right-0 bg-[#166636] z-10 shadow-secondary py-4 ${!menuOpen ? '-translate-y-[100vh]' : 'translate-y-0'} transition-all duration-700`}>
      ...
      <div className="w-full hidden lg:flex flex-col lg:flex-row items-center gap-8 text-white mt-8">
