    ...
    <section>
      <div className="px-4 lg:px-12 w-full bg-[#f4f4f5] text-[#181818] flex flex-col lg:flex-row items-center gap-8 lg:gap-16 py-8 lg:py-16">
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
            <div>
            <span className="border-[1px] font-lato text-[16px] text-[#181818] px-4 py-1.5 border-[#cdf8d4] rounded-full bg-[#f0fdf4]">
          ...
          <span className="flex items-center gap-2 font-lato text-[16px] text-[#666]">
            <p>January 30, 2024</p>
        ...
        <div className="w-full lg:w-1/3">
          <div className="border-[1px] rounded-lg border-[#e5e5e5] p-4">
            <div className="flex flex-col gap-4 ">
              <h4 className="text-[24px] font-normal font-sequel leading-[1.67] text-[#17171a]">
                Subscribe to newsletter
              </h4>
              <p className="text-[16px] text-[#53535c] leading-[1.25] tracking-[0.16px] font-sequel">
              ...
              <p className="text-[14px] font-lato leading-[1.86] tracking-[0.16px] text-[#707079] font-medium">
                By subscribing you agree to with our Privacy Policy.
              </p>
            </div>
            <div className="mt-8 space-y-4">
              <p className="font-medium font-lato leading-[1.5] tracking-[0.48px] text-[#53535c] text-[12px]">SHARE THIS POST</p>
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-8">
          {newData.map((item, idx) => (
            <div key={idx} className="flex flex-col gap-4">
              <h2 className="text-[40px] font-sequel leading-[1.2] tracking-[-0.48px] text-[#17171a]">
                {item.topic}
              </h2>
              {item.sub_topic !== null && (
                <div className="flex gap-4 items-center border-l-[1px] border-[#53535c] p-4">
                  <p className="text-[24px] font-sequel leading-[1.25] text-[#1c1c1c]">{item.sub_topic}</p>
                </div>
              )}
              <p className="text-[18px] font-lato leading-[1.67] text-[#53535c]">{item.details}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="px-4 lg:px-12 py-8 lg:py-16 w-full flex flex-col gap-4">
        <h1 className="text-[40px] font-sequel leading-[1.2] tracking-[-0.48px]">Related post</h1>
